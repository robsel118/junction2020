...
# Add endpoint URL here for /addWeight
ENDPOINT_URL = 'INSERT URL'

'''
Uncomment for firebase implementation, current one makes a HTTP POST request to the firebase functions
...
def uploadValue(newValue):
	print('uploadValue: The type is '+ str(type(newValue)))
